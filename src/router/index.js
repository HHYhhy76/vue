...
const routes = [
  ...
  {
    path: '/st_index', //访问路径 http://127.0.0.1:5173/cx/XfDGdOkjVo7deIxQjurcf8BEnNf
    name: 'st_index', //命名路由
    component: () => import('@/views/pages/student/index.vue'),
  },
  {
    path: '/sh_index', //访问路径 http://127.0.0.1:5173/cx/XfDGdOkjVo7deIxQjurcf8BEnNf
    name: 'sh_index', //命名路由
    component: () => import('@/views/pages/school/index.vue'),
  },
  {
    path: '/cs_index', //访问路径 http://127.0.0.1:5173/cx/XfDGdOkjVo7deIxQjurcf8BEnNf
    name: 'cs_index', //命名路由
    component: () => import('@/views/pages/class/index.vue'),
  },
  {
    path: '/sci_index', //访问路径 http://127.0.0.1:5173/cx/XfDGdOkjVo7deIxQjurcf8BEnNf
    name: 'sci_index', //命名路由
    component: () => import('@/views/pages/scientific/index.vue'),
  },
  // {
